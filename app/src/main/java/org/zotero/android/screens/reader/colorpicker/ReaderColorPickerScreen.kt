...
@Composable
internal fun ReaderColorPickerScreen(
    onBack: () -> Unit,
    viewModel: ReaderColorPickerViewModel = hiltViewModel(),
    args: ReaderColorPickerArgs?,
) {
...
private fun ColorPicker(
    viewState: ReaderColorPickerViewState,
    viewModel: ReaderColorPickerViewModel
) {
